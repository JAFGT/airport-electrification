...
# TIMELINE GRAPHICS (FOR SCENARIOS)
            ...
            <div class="timeline-container">
                <div class="row-container">
                    ...
                    <div class="bar-container">
                        ...
                        <div class="segment seg-light-blue" style="width: {comm_rem}%;">{comm_rem}%</div>
                    </div>
                </div>
                <div class="row-container">
                    ...
                    <div class="bar-container">
                        ...
                        <div class="block-splitter"></div>
                        <div class="segment seg-dark-green" style="width: {biz_rem}%;">{biz_rem}%</div>
                    </div>
                </div>
            </div>
            """)
...
# -----------------------------------------------------------
    ...
    st.markdown('<p style="font-size: 48px; color: #ffffff; font-weight: bold; margin-bottom: 20px;">✈️ Scenario Decision Dashboard ⚡️</p>', unsafe_allow_html=True)
