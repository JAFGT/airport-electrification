...
/* SLIDER COLORS */
.stSlider [data-baseweb="slider"] > div > div > div {background-color: #b0a36f !important;} /*KNOB*/
.stSlider [data-baseweb="slider"] > div > div > div > div > div {background-color: #b0a36f !important;} /*KNOB*/
